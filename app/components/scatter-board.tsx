...
const BOARD_IMAGES = [
  {
    ...
    side: "left" as const,
    startVY: 0.1,
    label: "Search trend tools (GettyImages & iStock)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "3%",
  ...
  },
  {
    ...
    side: "right" as const,
    startVY: 0.15,
    label: "Contribution submission app (GettyImages & iStock)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "2%",
    ...
    side: "right" as const,
    startVY: 0.2,
    label: "Abstract poster/wallpaper (Figma design)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "30%",
    ...
    side: "left" as const,
    startVY: 0.4,
    label: "Anonymous Letters Across Time (Figma Make)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "28%",
  ...
  },
  {
    ...
    side: "right" as const,
    startVY: 0.45,
    label: "Vibe coding playlist (Claude Code)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "30%",
    ...
    side: "right" as const,
    startVY: 0.5,
    label: "Food delivery app (Figma design)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "72%",
    ...
    side: "left" as const,
    startVY: 0.7,
    label: "Abstract elements (Figma design)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "70%",
    ...
    side: "right" as const,
    startVY: 0.7,
    label: "Landing pages (Figma design)",
  },
  {
    src: "/sequence/ezgif-frame-001.jpg",
    top: "70%",
    ...
    side: "right" as const,
    startVY: 0.65,
    label: "3D cabin (Claude Artifact)",
  },
];
...
function ScatterImage({
  ...
  setBursts: React.Dispatch<
    React.SetStateAction<{ id: number; x: number; y: number }[]>
  >;
}) {
  const sideIndex = BOARD_IMAGES.slice(0, index).filter(
    (b) => b.side === img.side,
  ).length;
  ...
  return (
    <motion.div
      ...
      onTap={(e) => {
        ...
        setBursts((prev) => [
          ...prev,
          { id: Date.now(), x: evt.clientX, y: evt.clientY },
        ]);
      }}
...
export function ScatterBoard({
  ...
  return (
    <>
      <motion.div
        className="w-full flex flex-col justify-center items-center gap-8 px-4 lg:px-6 pt-4 pb-4"
      ...
      >
        ...
        <div className="w-[calc(100vw-32px)] lg:w-full max-w-[1200px] board-float">
          <div
            className="rounded-3xl p-[14px]"
            style={{
              background:
                "linear-gradient(160deg, #d6cfc4 0%, #c9c0b3 20%, #bfb5a6 80%, #b5aa9a 100%)",
              boxShadow:
                "0 10px 30px rgba(0,0,0,0.12), 0 24px 70px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.5), inset 0 -1px 0 rgba(0,0,0,0.1)",
          ...
          >
            <div
              ref={boardRef}
              className={`${isMobile ? "min-h-[420px]" : "min-h-[750px]"} rounded-xl relative overflow-hidden`}
              style={{
                background: "#F7F1E8",
            ...
            >
              ...
              <div className="absolute top-0 left-0 bottom-0 w-[24px] flex flex-col pointer-events-none select-none">
                {"47.6062°N 122.3321°W".split("").map((ch, i) => (
                  <span
                    key={i}
                    className="font-mono text-[9px] text-stone-400 text-center"
